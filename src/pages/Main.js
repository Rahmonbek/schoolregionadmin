            ...
            <Layout className="site-layout">
              ...
              <Content style={{ margin: "0 16px" }}>
                ...
                <nav className={style.nvb}>
                  <Menu
                    defaultSelectedKeys={["rahbariyat"]}
                  ...
                  >
                    <Menu.Item key="rahbariyat" icon={<UserOutlined />}>
                      <Link
                        exact
                        to={`/main/rahbariyat/${this.state.oneId}`}
                    ...
                    <Menu.Item key="yangiliklar" icon={<BookOutlined />}>
                      <Link
                        style={{ textDecoration: "none" }}
                        exact
                        to={`/main/yangiliklar/${this.state.oneId}`}
                      >
                        Yangiliklar
                      </Link>
                    </Menu.Item>
                    <Menu.Item key="tadbirlar" icon={<BellOutlined />}>
                      <Link
                        exact
                        to={`/main/tadbirlar/${this.state.oneId}`}
                        style={{ textDecoration: "none" }}
                      >
                        Tadbirlar
                      </Link>
                    ...
                    <Menu.Item key="togaraklar" icon={<BellOutlined />}>
                      <Link
                        exact
                        to={`/main/togaraklar/${this.state.oneId}`}
                        style={{ textDecoration: "none" }}
                      >
                        To'garaklar
                      </Link>
                    ...
                    <Menu.Item key="yutuqlar" icon={<BellOutlined />}>
                      <Link
                        exact
                        to={`/main/yutuqlar/${this.state.oneId}`}
                        style={{ textDecoration: "none" }}
                      >
                        Yutuqlar
                      </Link>
                    ...
                    <Menu.Item key="alochilar" icon={<RocketOutlined />}>
                      <Link
                        refresh="true"
                        exactexact
                        to={`/main/alochilar/${this.state.oneId}`}
                        style={{ textDecoration: "none" }}
                      >
                        Alochilar
                      </Link>
