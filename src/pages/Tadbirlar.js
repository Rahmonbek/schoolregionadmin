    ...
    return (
      <div>
                    ...
                    <Col lg={3} md={4} sm={6} xs={12}>
                      <Card style={{ margin: "10px auto", borderRadius: "7px", boxShadow: "rgba(0, 0, 0, 0.16) 0px 1px 4px",height:'500px' }}>
                        ...
                        <Card.Body>
                          ...
                          <span style={{marginRight:'10px', }}><HiLocationMarker/></span><span >{item.address}</span>
                          </div>
                          <div style={{margin:'10px 0px', fontSize:'15px'}}>
                          <span style={{marginRight:'10px'}}><FaRegCalendarAlt/></span><span >{item.date}</span>
                          </div>
                          <div style={{margin:'10px 0px', fontSize:'15px'}}>
                          <span style={{marginRight:'10px'}}><FaHistory/></span><span >{item.time}</span>
                          </div>
        ...
        <Modal show={this.state.show} size="lg" aria-labelledby="contained-modal-title-vcenter" centered>
          <Modal.Header>
            <Modal.Title id="contained-modal-title-vcenter">Tadbir sarlavhasi:   <b>"{this.state.data.title}"</b> </Modal.Title>
          </Modal.Header>
          <Modal.Body>
